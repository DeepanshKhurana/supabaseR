...
All three modes should work depending on your configuration. If `Direct Connection` doesn't work, try `Transaction Pooler` or `Session Pooler`. Be sure to use the correct host, user, and password for your chosen mode.
